...
ZCam is based on an older (unpublished) program of mine. This is an attempt to port that program to a more modern platform.

In its current state, ZCam is still under development and is not yet usable.
