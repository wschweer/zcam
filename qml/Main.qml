...
Window {
    ...
    visible: true
    title: ProjectManager.projectName + (ProjectManager.dirty ? " *" : "") + " – ZCam"
    ...
    Action {
        ...
        enabled: ProjectManager.canUndo
        onTriggered: ProjectManager.undo()
        }
    ...
    Action {
        ...
        enabled: ProjectManager.canRedo
        onTriggered: ProjectManager.redo()
        }
    ...
    FileDialog {
        ...
        onAccepted: ProjectManager.openProject(selectedFile.toString().replace("file://", ""))
        }
    ...
    FileDialog {
        ...
        defaultSuffix: "zcam"
        onAccepted: ProjectManager.saveAs(selectedFile.toString().replace("file://", ""))
        }
    ...
    FileDialog {
        ...
        fileMode: FileDialog.OpenFile
        onAccepted: ProjectManager.importFile(selectedFile.toString().replace("file://", ""))
        }
    ...
    Dialog {
        ...
        onDiscarded: ProjectManager.newProject()   // Discard
        }
