...
| **Manual** | Integrated manual (MkDocs-generated, displayed via WebEngine). |
...
The tab bar switches between the five main panels: **Main**, **Recipes**,
**Machines**, **Config**, and **Manual**.
