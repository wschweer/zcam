...
| **Manual** | Integriertes Handbuch (MkDocs-generiert, via WebEngine angezeigt). |
...
Die Tab-Leiste schaltet zwischen den fünf Hauptpanels um: **Main**, **Recipes**,
**Machines**, **Config** und **Manual**.
