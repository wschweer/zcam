...
bool GetSegmentIntersection(const Point64& p1, const Point64& p2, const Point64& p3, const Point64& p4, Point64& ip) {
...
inline bool GetIntersection(const Path64& rectPath, const Point64& p, const Point64& p2, Location& loc, Point64& ip) {
...
inline bool IsClockwise(Location prev, Location curr, const Point64& prev_pt, const Point64& curr_pt, const Point64& rect_mp) {
...
inline bool HasHorzOverlap(const Point64& left1, const Point64& right1, const Point64& left2, const Point64& right2) {
      return (left1.x < right2.x) && (right1.x > left2.x);
      }

inline bool HasVertOverlap(const Point64& top1, const Point64& bottom1, const Point64& top2, const Point64& bottom2) {
...
void RectClip64::GetNextLocation(const Path64& path, Location& loc, size_t& i, size_t highI) {
      switch (loc) {
            case Location::Left:
...
void RectClip64::ExecuteInternal(const Path64& path) {
      ...
      if (first_cross_ == Location::Inside) {
            ...
            if (starting_loc != Location::Inside) {
                  ...
                  if (path_bounds_.Contains(rect_) && Path1ContainsPath2(path, rect_as_path_)) {
